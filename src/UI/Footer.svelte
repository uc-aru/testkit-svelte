<script>
    ...
    import EndTestModal from './Modal.svelte';
    import { question ,correctans ,allques,attempted,currentcorrect,selectedanswer,currentitem,counter,disable1,disable2,list,correctques,isopen,timetaken } from "../dataStore";
    ...
    {#each $question as dataItem, i (dataItem)}
      {#if i == $currentitem}
        ...
        <footer class="bottom-nav">
          <span class="buttons">
          <!-- p for previous the button ,n for Next the button,l for list the button,t for End Test the button and r for Refresh whole page(Dashboard)-->
